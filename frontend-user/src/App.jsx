...
function AccountVerificationPage() {
  ...
  return (
    <div className="min-h-screen bg-black px-4 py-8 text-white">
      <div className="mx-auto max-w-md rounded-[30px] border border-white/10 bg-[#111111] p-6 shadow-2xl">
        <div className="text-center">
          <div className="text-[11px] uppercase tracking-[0.32em] text-lime-300">
        ...
        <div className="mt-6 grid gap-3">
          {!emailVerified ? (
            <button
              ...
              className="rounded-2xl bg-lime-400 px-4 py-3 text-sm font-semibold text-black"
            >
