      ...
      <div className="flex min-h-screen">
        ...
        {sidebarOpen && (
          <div className="fixed inset-0 z-50 flex md:hidden">
            ...
            />
            <div className="h-full w-[85%] max-w-sm border-l border-white/10 bg-black shadow-2xl overflow-y-auto">
              <UserSidebar
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          {/* Header */}
          <header className="sticky top-0 z-30 border-b border-white/10 bg-black/95 backdrop-blur-xl safe-top">
