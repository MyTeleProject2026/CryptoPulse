...
export default function PlanNoteModal({ isOpen, onClose, plan }) {
  ...
  const backgroundImage = plan.note_background_image || plan.background_image || null;
      ...
      <div className="relative w-full max-w-2xl rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 max-h-[80vh] overflow-y-auto bg-gradient-to-b from-black/80 to-black/60 p-6">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border border-white/10 bg-black/40 p-4">
              ...
              <div className="space-y-2 text-sm text-slate-300">
                ...
                <p><span className="text-slate-500">Daily Profit:</span> {plan.min_daily_profit_percent}% - {plan.max_daily_profit_percent}%</p>
          ...
          <div className="mt-6 flex justify-end">
            <button
              onClick={onClose}
              className="rounded-xl bg-lime-400 px-6 py-2 text-sm font-semibold text-black transition hover:bg-lime-300"
            >
              Close
            </button>
          </div>
