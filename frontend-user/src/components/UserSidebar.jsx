...
export default function UserSidebar({ onNavigate, onClose, showClose = false }) {
  ...
  return (
    <aside className="flex h-full min-h-0 w-full flex-col bg-[#111111] text-white">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5">
        <div className="space-y-5">
          ...
          <div className="rounded-[26px] border border-white/10 bg-black/30 p-4">
            ...
            {hasJointAccount && (
              <div className="mt-1 text-[10px] text-lime-400">
  ...
  return (
    <button
      ...
      className={`flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-left transition ${
        active
          ? "border border-lime-500/25 bg-lime-500/10 text-lime-300"
          : "text-white hover:bg-white/5"
      }`}
    >
      <Icon size={20} className={active ? "text-lime-300" : "text-slate-400"} />
