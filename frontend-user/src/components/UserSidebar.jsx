...
export default function UserSidebar({ onNavigate, onClose, showClose = false }) {
  ...
  return (
    <aside className="flex h-full min-h-0 w-full flex-col bg-[#070707] text-white">
      <div className="shrink-0 border-b border-white/10 bg-[#081223] px-5 py-5">
        <div className="flex items-center justify-between">
          <div className="text-[18px] font-semibold text-white">CryptoPulse</div>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5">
        <div className="space-y-5">
          ...
          <div className="rounded-[26px] border border-white/10 bg-[#111111] p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-2xl bg-lime-400 px-4 py-3 font-semibold text-black transition hover:bg-lime-300"
            >
              <Download size={16} />
              Deposit
            </button>
