...
export default function SplashScreen() {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden bg-[#07111f] transition-opacity duration-700 ${
        fadeOut ? "opacity-0" : "opacity-100"
      }`}
    >
      {/* background */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.16),transparent_32%),radial-gradient(circle_at_top,rgba(59,130,246,0.12),transparent_30%),linear-gradient(to_bottom,#07111f,#050b14)]" />
      ...
      <div className="absolute left-1/2 top-1/2 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-sky-300/10 animate-ping [animation-duration:2.11s]" />
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <span className="absolute right-[22%] bottom-[18%] h-1.5 w-1.5 rounded-full bg-sky-300/60 animate-ping" />
      </div>
