...
export default function NewsSlider() {
  ...
  return (
    <section className="overflow-hidden rounded-[34px] border border-white/10 bg-[#0d0d0d] shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
      <div className="relative min-h-[220px] overflow-hidden sm:min-h-[250px]">
        ...
        <div className="relative z-10 flex min-h-[220px] flex-col justify-between p-5 sm:min-h-[250px] sm:p-6">
          <div className="flex items-center justify-between gap-3">
            <div className="inline-flex items-center gap-2 rounded-full border border-lime-400/20 bg-lime-400/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-lime-300">
              <Newspaper size={14} />
              CryptoPulse News
            </div>
      ...
      {items.length > 1 ? (
        <div className="grid gap-3 border-t border-white/10 bg-black/40 p-4 sm:grid-cols-3">
