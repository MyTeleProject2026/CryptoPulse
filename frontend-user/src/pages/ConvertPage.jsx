...
export default function ConvertPage() {
  ...
  return (
    <div className="space-y-5 bg-black px-3 pb-28 pt-3 sm:px-5 xl:pb-8">
      <section className="rounded-[34px] border border-white/10 bg-[radial-gradient(circle_at_top_right,rgba(163,230,53,0.10),transparent_18%),linear-gradient(180deg,#0a0a0a_0%,#050505_100%)] p-4 shadow-[0_20px_80px_rgba(0,0,0,0.45)] sm:p-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p className="text-[10px] uppercase tracking-[0.32em] text-lime-300 sm:text-xs">
              Asset Convert
            </p>
      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_0.95fr]">
          ...
          <div className="space-y-4 p-4 sm:p-5">
              ...
              <div className="grid gap-4 md:grid-cols-[1fr_170px]">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-3 text-white outline-none focus:border-lime-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      value={form.fromCoin}
                      onChange={handleChange}
                      className="w-full appearance-none rounded-2xl border border-white/10 bg-black/40 px-4 py-3 pr-10 text-white outline-none focus:border-lime-400"
                    >
                      {COINS.map((coin) => (
            ...
            <div className="flex justify-center">
              <button
                type="button"
                onClick={handleSwap}
                className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-lime-400 text-black transition hover:scale-105 hover:bg-lime-300"
              >
                <ArrowUpDown size={18} />
              </button>
            </div>
        ...
        <GlassCard>
          ...
          <div className="space-y-4 p-4 sm:p-5">
            <div className="rounded-[22px] border border-white/10 bg-black p-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-[22px] border border-white/10 bg-[#121212] p-4">
                ...
                <div className="mt-2 text-lg font-semibold text-lime-300 sm:text-xl">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <button
                ...
                disabled={executing}
                className="rounded-2xl bg-lime-400 px-4 py-3 text-sm font-semibold text-black transition hover:bg-lime-300 disabled:cursor-not-allowed disabled:opacity-60"
              >
