...
function SearchCard({ search, setSearch, count }) {
  return (
    <section className="rounded-[30px] border border-white/10 bg-[#0f0f0f] p-4 shadow-[0_18px_60px_rgba(0,0,0,0.35)]">
      <div className="grid gap-4 lg:grid-cols-[1fr_auto]">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-white/10 bg-[#171717] py-3 pl-11 pr-4 text-white outline-none focus:border-lime-400"
          />
        </div>

        <div className="flex items-center justify-center rounded-2xl border border-white/10 bg-black px-4 py-3 text-sm text-slate-300">
...
function DocumentCard({ doc, onOpen }) {
  ...
  return (
    <div className="rounded-[30px] border border-white/10 bg-[#0f0f0f] p-5 shadow-[0_18px_60px_rgba(0,0,0,0.35)] transition hover:bg-[#121212]">
      ...
      <div className="mt-5 flex flex-wrap gap-3">
        <button
          type="button"
          onClick={() => onOpen(doc)}
          className="inline-flex items-center justify-center gap-2 rounded-2xl bg-lime-400 px-4 py-2 text-sm font-semibold text-black transition hover:bg-lime-300"
        >
          Read More
        </button>
            ...
            {doc.file_url ? (
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-2 rounded-2xl bg-lime-400 px-4 py-3 text-sm font-semibold text-black transition hover:bg-lime-300"
                >
                  <ExternalLink className="h-4 w-4" />
                  View Document
                </a>
...
export default function LegalDocumentsPage() {
  ...
  if (loading) {
    return (
      <div className="space-y-6 bg-black p-4 sm:p-6">
        <section className="rounded-[30px] border border-white/10 bg-[#0f0f0f] p-6 text-slate-300 shadow-[0_18px_60px_rgba(0,0,0,0.35)]">
  ...
  return (
    <>
      <div className="space-y-6 bg-black px-4 pb-28 pt-4 sm:px-6 xl:pb-8">
        ...
        {filteredDocuments.length ? (
          ...
          <section className="rounded-[30px] border border-white/10 bg-[#0f0f0f] px-4 py-12 text-center text-sm text-slate-400 shadow-[0_18px_60px_rgba(0,0,0,0.35)]">
            No documents found.
          </section>
        )}
      </div>
