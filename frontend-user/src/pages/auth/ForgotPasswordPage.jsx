            ...
            <div className="rounded-[34px] border border-white/10 bg-[linear-gradient(180deg,#0c0c0c_0%,#090909_100%)] p-8 shadow-[0_25px_90px_rgba(0,0,0,0.5)]">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button className="flex w-full items-center justify-center gap-2 rounded-2xl bg-lime-400 px-4 py-4 font-semibold text-black transition hover:bg-lime-300">
                    Send Reset Link
                    <ArrowRight size={18} />
                  </button>
                </form>
