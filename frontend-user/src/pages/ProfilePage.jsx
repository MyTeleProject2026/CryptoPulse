...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <div className="space-y-5 bg-black p-3 sm:p-6">
        <section className="rounded-[30px] border border-white/10 bg-[#111111] p-5 text-slate-300 shadow-2xl">
          Loading profile...
        </section>
      </div>
    );
    ...
    <div className="space-y-5 bg-black px-2 pb-24 pt-3 sm:px-6 xl:pb-8">
      ...
      {isEditing ? (
        <div className="fixed inset-0 z-50 bg-black/80 p-4 backdrop-blur-sm">
          <div className="mx-auto mt-10 w-full max-w-md rounded-[28px] border border-white/10 bg-[#111111] p-5 shadow-2xl">
            <div className="mb-5 flex items-center justify-between">
