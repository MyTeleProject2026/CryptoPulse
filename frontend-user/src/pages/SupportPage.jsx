...
export default function SupportPage() {
  ...
  if (loading) {
    return (
      <div className="space-y-5 bg-black px-3 pb-24 pt-3 sm:px-6">
        <section className="rounded-[28px] border border-white/10 bg-[#111111] p-5 text-slate-300">
  ...
  return (
    <div className="space-y-5 bg-black px-3 pb-24 pt-3 sm:px-6">
      <section className="rounded-[28px] border border-white/10 bg-[#111111] p-5 shadow-2xl">
