...
// ✅ ADDED FROM VexaTrade: Import Profit Withdrawal Modal
...
export default function WithdrawPage() {
  ...
  // ✅ ADDED FROM VexaTrade: Target system states for profit withdrawal
  ...
  // ✅ ADDED FROM VexaTrade: Check user target
  ...
  // ✅ ADDED FROM VexaTrade: Refresh target progress
  ...
  async function handleSubmit(e) {
    ...
    // ✅ ADDED FROM VexaTrade: Check if main withdraw is disabled due to target not achieved
  ...
  return (
    <div className="space-y-6 bg-[#050812] px-4 pb-28 pt-4 sm:px-6 xl:pb-8">
      ...
      {/* ✅ ADDED FROM VexaTrade: Target Progress Banner for Profit Withdrawal Info */}
      ...
      {tab === "request" ? (
        <div className="grid gap-6 xl:grid-cols-[1fr_0.9fr]">
          <GlassCard>
            ...
            {/* ✅ ADDED FROM VexaTrade: Warning banner when main withdraw is disabled due to target not achieved */}
          ...
          <GlassCard>
            ...
            <div className="space-y-4 p-5">
              ...
              {/* ✅ ADDED FROM VexaTrade: Profit Balance Section - Always show if has target */}
              {hasTarget && (
      ...
      {/* ✅ ADDED FROM VexaTrade: Profit Withdrawal Modal */}
