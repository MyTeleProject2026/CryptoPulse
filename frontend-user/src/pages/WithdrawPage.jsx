          ...
          <GlassCard>
            <div className="border-b border-white/10 px-5 py-4">
              <div className="flex items-center gap-3">
                <ArrowUpToLine size={18} className="text-lime-300" />
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-[#171717] p-3 text-white outline-none focus:border-lime-400"
