        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-4">
            <div className="flex justify-between mb-2">
              ...
              <span className="text-lime-300 font-semibold">{currentProfit.toFixed(2)} USDT</span>
            </div>
            <div className="flex justify-between mb-2">
            ...
            <div className="mt-2">
              ...
              <div className="h-2 rounded-full bg-white/10 overflow-hidden">
                <div className="h-full bg-lime-400 rounded-full" style={{ width: `${Math.min(100, progressPercent)}%` }} />
              </div>
            </div>
          </div>
            ...
            <>
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-[#0f0f0f] px-4 py-3 text-white outline-none focus:border-lime-400"
                />
          ...
          <button
            ...
            className="w-full rounded-xl bg-lime-400 py-3 font-semibold text-black transition hover:bg-lime-300 disabled:opacity-60"
          >
