...
function TopPriceCard({ label, value, valueClassName = "text-white", flash = false }) {
  return (
    <div
      className={`rounded-[24px] border border-white/10 bg-[#0f0f0f] px-4 py-3 shadow-[0_10px_34px_rgba(0,0,0,0.24)] transition ${
        flash ? "scale-[1.01] border-lime-400/20" : ""
      }`}
    >
    ...
    <div className="space-y-4 bg-black p-3 pb-24 sm:space-y-5 sm:p-6 xl:pb-6">
      ...
      <div className="grid gap-4 xl:grid-cols-[1.48fr_0.92fr]">
        <section className="space-y-4">
          <div className="rounded-[30px] border border-white/10 bg-[#0f0f0f] p-4 shadow-xl sm:p-5">
          ...
          <div className="rounded-[30px] border border-white/10 bg-[#0f0f0f] p-4 shadow-xl sm:p-5">
            ...
            <div className="my-3 rounded-[22px] border border-white/10 bg-black px-4 py-3 text-center">
        ...
        <section className="space-y-4">
          <div className="xl:hidden rounded-3xl border border-white/10 bg-[#0f0f0f] p-2 shadow-xl">
            ...
            <div className="rounded-[30px] border border-white/10 bg-[#0f0f0f] p-4 shadow-xl sm:p-5">
              ...
              <form onSubmit={handlePlaceTrade} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full rounded-2xl bg-lime-400 px-4 py-3.5 text-[17px] font-semibold text-black transition hover:bg-lime-300 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {placing
                    ? "Placing Trade..."
            ...
            <div className="rounded-[30px] border border-white/10 bg-[#0f0f0f] p-4 shadow-xl sm:p-5">
              ...
              <div className="space-y-3">
                {openTrades.length ? (
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black px-4 py-8 text-center text-sm text-slate-400">
